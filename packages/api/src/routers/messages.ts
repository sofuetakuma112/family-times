...
export const messagesRouter = {
  ...
  update: protectedProcedure
    ...
    .handler(async ({ input, context }) => {
      ...
      notifyMessageUpdated(msg.channelId, {
        id: input.messageId,
        message: input.message,
        isEdited: true,
      });
  ...
  delete: protectedProcedure
    ...
    .handler(async ({ input, context }) => {
      ...
      notifyMessageDeleted(msg.channelId, input.messageId);
      return { success: true };
    }),
  ...
  react: protectedProcedure
    ...
    .handler(async ({ input, context }) => {
      ...
      const msg = await verifyMessageAccess(userId, input.messageId);
      ...
      if (existing) {
        ...
        notifyReaction(msg.channelId, input.messageId, {
          action: "removed",
          emoji: input.emoji,
          userId,
        });
